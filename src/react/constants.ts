...
export const errors = {
	...
	ADDRESS_FORMAT_ERROR: "Please enter a valid Gnosis Chain/Ethereum address.",
	WITHDRAW_ADDRESS_REQUIRED: "Please enter a Gnosis Chain/Ethereum address.",
...
export const tooltips = {
	IMPORT_MNEMONIC: "If you've already created a Secret Recovery Phrase, you can use it to regenerate your original keys, create more keys, or generate a BLS to execution change (BTEC) message by importing the phrase here.",
	...
	ETH1_WITHDRAW_ADDRESS: "A Gnosis Chain/Ethereum address to be used for the withdrawal credentials.",
	BTEC_WITHDRAW_ADDRESS: "A Gnosis Chain/Ethereum address for withdrawal. There is where your validator balance and rewards will go.",
	...
	BTEC_INDICES: "A list of the chosen validator index number(s) as identified on the Gnosis Beacon Chain. You can find your validator indice on the gnosischa.in website on your validator page. It will be at the top of that page the form of a title like Validator XXXXX, where XXXXX is going to be your indice.",
	BLS_CREDENTIALS: "A list of the old BLS withdrawal credentials of the given validator(s). You can find your validator BLS withdrawal credentials on the gnosisncha.in website on your validator page. It will be in the Deposits tab and it should start with 0x00.",
};
