...
export const errors = {
	...
	ADDRESS_FORMAT_ERROR: "Please enter a valid Gnosis Chain address.",
	WITHDRAW_ADDRESS_REQUIRED: "Please enter a Gnosis Chain address.",
...
export const tooltips = {
	...
	ETH1_WITHDRAW_ADDRESS: "A highly reccomended Gnosis Chain address to be used for the withdrawal credentials.",
	BTEC_WITHDRAW_ADDRESS: "A Gnosis Chain address for withdrawal. There is where your validator balance and rewards will go.",
